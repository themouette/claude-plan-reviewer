...
- [ ] 28-01-PLAN.md — Move connectivity.ts + useHeartbeat.ts from reviewer-v2/ to shared/; update reviewer-v2 imports + ESLint rule
...
| 28. Review Submission | v0.7.0 | 0/3 | Not started | - |
