...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude
                  → checks /Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done
                  → writes to /Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/hooks/
...
@/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
