...
<required_reading>
@/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/references/user-story-template.md
@/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/references/spidr-splitting.md
@/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
