...
<required_reading>
@/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/references/ai-frameworks.md
@/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/agents/gsd-eval-planner.md for instructions.
