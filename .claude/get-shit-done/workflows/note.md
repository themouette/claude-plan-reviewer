...
- **Global scope**: `/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/notes/`)
...
2. Glob `/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/notes/` — works in any directory
