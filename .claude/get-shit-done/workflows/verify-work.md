...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/workflows/transition.md`.
