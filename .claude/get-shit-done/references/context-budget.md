...
The keys live in `.claude/settings.json` (project) or `/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/settings.json` (global) — **not** in `.planning/config.json`:
