...
<!-- For checkpoint task examples and patterns, see @/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/julien.muetton/Projects/lab/claude-plan-reviewer/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
